...
module.exports = {
  ...
  isStandardized: obj => {
    ...
    if (_.isBoolean(obj.constructor.isStandardized)) {
      return obj.constructor.isStandardized
    }

    if (className == Controller.name || className == Policy.name) {
      return obj.constructor.isStandardized = true
    }
    else if (className == 'Object') {
      return obj.constructor.isStandardized = false
    }
    else {
      return obj.constructor.isStandardized = lib.Util.isStandardized(obj.__proto__)
    }
  },
